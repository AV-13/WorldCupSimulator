...
# docker build -t world_cup_simulator .
# docker run -d -p 80:80 -e RAILS_MASTER_KEY=<value from config/master.key> --name world_cup_simulator world_cup_simulator
...
# Install packages needed to build gems (including PostgreSQL dev)
RUN apt-get update -qq && \
